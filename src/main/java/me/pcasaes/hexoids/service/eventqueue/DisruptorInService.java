...
@ApplicationScoped
public class DisruptorInService {
    ...
    private final EventTranslatorOneArg<DisruptorInEvent, GameLoopService.GameRunnable> gameTranslator = this::translate;
    private RingBuffer<DisruptorInEvent> ringBuffer;
    private Disruptor<DisruptorInEvent> disruptor;

    @Inject
    public DisruptorInService(
    ...
    void enqueueClient(final Dto dto) {
        this.ringBuffer
    ...
    private void translate(DisruptorInEvent event, long sequence, GameLoopService.GameRunnable runnable) {
        event
                .clear()
    ...
    public static class DisruptorInEvent {
        ...
        public DisruptorInEvent setGameRunnable(GameLoopService.GameRunnable gameRunnable) {
