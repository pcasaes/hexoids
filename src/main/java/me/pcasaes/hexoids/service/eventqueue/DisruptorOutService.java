...
@ApplicationScoped
public class DisruptorOutService {
    ...
    public DisruptorOutService(
        ...
        this.metrics.get(0).setName(domainEventEventQueueConsumerService.getName());
        this.metrics.get(1).setName(clientEventEventQueueConsumerService.getName());
    }
    ...
    private void handleDomainEventHandler(DisruptorOutEvent event, long sequence, boolean endOfBatch) {
        ...
        if (domainEvent != null) {
            ...
            try {
                this.domainEventEventQueueConsumerService.accept(domainEvent);
            } finally {
    ...
    private void handleClientEventHandler(DisruptorOutEvent event, long sequence, boolean endOfBatch) {
        ...
        if (clientEvent != null) {
            ...
            try {
                this.clientEventEventQueueConsumerService.accept(clientEvent);
            } finally {
